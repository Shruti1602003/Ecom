...
mongoose.connect("mongodb+srv://chatterjeeshruti500:shruti@cluster0.opjashv.mongodb.net/Ecommerce")
...
app.post("/upload",upload.single('product'),(req,res)=>{
    res.json({
        success:1,
        image_url:`https://ecom-api-steel.vercel.app/images/${req.file.filename}`
    })
})
